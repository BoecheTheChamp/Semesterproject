 ...
 * @author mikkel
 */
@WebService(endpointInterface = "typeracer.RacerInterface")
public class Logik implements RacerInterface{
    
      //bruger login
    private Brugeradmin BI;

    // Påkrævet constructor
    public Logik() throws java.rmi.RemoteException, Exception
    {
      hentOrdFraDr();
